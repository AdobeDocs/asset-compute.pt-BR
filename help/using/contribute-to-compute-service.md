...
* Compartilhar feedback: Crie um problema do GitHub no repositório apropriado para relatar bugs no produto ou na documentação, solicitar aprimoramentos e solicitar novos recursos. Não tem certeza de qual repositório usar para enviar seu problema? Em caso afirmativo, registre um problema no [repositório do Asset Compute SDK](https://github.com/adobe/asset-compute-sdk) para que ele seja roteado adequadamente.
